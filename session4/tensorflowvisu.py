...
class MnistDataVis:
    ...
    def __init__(self, title1=None, title2=None, title3=None, title4=None, title5=None, title6=None, histogram4colornum=None, histogram5colornum=None, dpi=70):
        ...
        fig = plt.figure(figsize=(9.60,5.40), dpi=dpi)
    ...
    def create_animation(self, compute_step, iterations, train_data_update_freq=20, test_data_update_freq=100, one_test_at_start=True, more_tests_at_start=False):
        def animate_step(i):
        ...
        return animation.FuncAnimation(self._mpl_figure, animate_step, int(iterations // train_data_update_freq + 1), init_func=self._mlp_init_func, interval=16, repeat=False, blit=False)
    ...
    def animate(self, compute_step, iterations, train_data_update_freq=20, test_data_update_freq=100, one_test_at_start=True, more_tests_at_start=False, save_movie=False):
        self._animation = self.create_animation(compute_step, iterations, train_data_update_freq=train_data_update_freq, test_data_update_freq=test_data_update_freq, one_test_at_start=one_test_at_start, more_tests_at_start=more_tests_at_start)
